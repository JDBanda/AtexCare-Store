"""
Django settings for atexcare project.
...
# Configuraciones de EMAIL ENTRANTE
EMAIL_HOST = 'mail.atexcare.com.mx'
EMAIL_HOST_USER = 'finanzas@atexcare.com.mx'
EMAIL_HOST_PASSWORD = 'Finanzas0.'
EMAIL_PORT = 587  # Entrante
EMAIL_USE_TLS = False
